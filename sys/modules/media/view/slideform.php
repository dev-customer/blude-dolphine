...
<div class="box">
 	<div class="headMod bg-sdt1">
		<h2 class="col-md-6 text-left alert modTitle"><span class="glyphicon glyphicon-bookmark"></span> <?= (($mod->method=='add')? LANG_ADD : LANG_EDIT).' '.MENU_SLIDE ?></h2> 
	...
	<form method="post" enctype="multipart/form-data" name="frm_list" action="index.php?p=media&q=slide">
		<div id="tab_general">
			...
			<tr>
			  ...
			  <td>
				<div class="col-md-3 input-group">
					...
					<?=
					showImg('../'.DIR_UPLOAD.'/slide/'.$row['image'], 'slide/'.$row['image'], 'no-image.png', 20, 20, "", "", '', '');
					?>
					<span class="glyphicon glyphicon-remove actDelImgItem" role="button" data-src="slide/<?=$row['image']?>"></span>
					</div> 
		...
		<input name="id_slide" id="id_slide" type="hidden" value="<?= @$row['id_slide'] ?>" />
